 ...
 * - `unavailable`: no verdict, because Cloudflare could not be reached or our own secret is
 *   wrong. The lead is kept and marked, so an outage never drops paid traffic.
 */
